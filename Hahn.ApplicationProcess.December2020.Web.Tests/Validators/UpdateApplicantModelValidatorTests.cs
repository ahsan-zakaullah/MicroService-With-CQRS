...
namespace Hahn.ApplicationProcess.December2020.Web.Tests.Validators
{
    ...
    public class UpdateApplicantModelValidatorTests
    {
        private readonly UpdateApplicantModelValidator _test;

        public UpdateApplicantModelValidatorTests()
        {
            _test = new UpdateApplicantModelValidator();
        }
